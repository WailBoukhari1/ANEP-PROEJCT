    ...
    const DashboardPage = () => {
        ...
        const ageData = Object.entries(demographicData.ageDistribution || {}).map(([age, count]) => ({ age, count }));
        const genderData = Object.entries(demographicData.genderDistribution || {}).map(([gender, count]) => ({ gender, count }));
