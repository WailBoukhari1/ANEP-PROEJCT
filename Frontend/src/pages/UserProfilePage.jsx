                          ...
                          {courses.enCours.length > 0 ? (
                            <table className="min-w-full border-collapse block md:table">
                              <thead className="block md:table-header-group">
                                <tr className="border-borderColor dark:border-borderColor-dark border md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto md:relative">
                                  <th className="bg-[#f4f4f4] dark:bg-whiteColor-dark p-2 text-blackColor font-bold md:border md:border-grey-500 text-left block md:table-cell">
                                    Titre
                                  </th>
                                  <th className="bg-[#f4f4f4] dark:bg-whiteColor-dark p-2 text-blackColor font-bold md:border md:border-grey-500 text-left block md:table-cell">
                                    Date de début
                              ...
                              <tbody className="block md:table-row-group">
                                {courses.enCours.map((course, index) => (
                                  <tr
                                    key={course._id}
                                    className={`bg-whiteColor dark:bg-whiteColor-dark border border-borderColor dark:border-borderColor-dark md:border-none block md:table-row ${
                                      index % 2 === 0
                                        ? "bg-[#f4f4f4] dark:bg-whiteColor-dark"
                                        : ""
                                    }`}
                                  >
